		...
		if (m_illum_technique == IllumTechnique::Rtbp) {
			...
			}
			{
				WriteImgDesc descs[IllumTechnique::Data::Rtbp::descriptorCombinedImageSamplerCount] {
					...
					{cur_frame.m_illumination_set, cis, 10, m_sampler_fb_lin, cur_frame.m_normal_geom_view, Vk::ImageLayout::ShaderReadOnlyOptimal},
					{next_frame.m_illumination_set, cis, 11, m_sampler_fb_lin, cur_frame.m_cdepth_view, Vk::ImageLayout::ShaderReadOnlyOptimal},
